...
public class MedicalFeeCreatedEvent implements DomainEvent {
    private final Long medicalFeeId;
    private final Long treatmentId;
    private final Long medicalTypeId;

    public MedicalFeeCreatedEvent(Long medicalFeeId, Long treatmentId, Long medicalTypeId) {
